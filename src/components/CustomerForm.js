...
const handlePurchaseHistoryChange = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`https://crm-mern-back-end.onrender.com/api/customers/${customer._id}`, customer);
        alert('Customer updated successfully');
      } else {
        await axios.post('https://crm-mern-back-end.onrender.com/api/customers', customer);
